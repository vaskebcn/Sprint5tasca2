...
import cat.itacademy.milos.diceGame.security.model.repository.DiceGameRepository;
...
public class DiceServiceImpl implements DiceService{
    ...
    public PlayerDto searchByEmail(String email){
        Player player = dicePlayerRepository.findByEmail(email).orElseThrow(()->new RuntimeException("no player found with email "+email));
        return convertFromPlayerToDto(player);
    }
    ...
    @Override
    public PlayerDto updatePlayer(String email, String name) {
        Player existingPlayer = dicePlayerRepository.findByEmail(email).get();
        existingPlayer.setName(name);
//        dicePlayerRepository.save(existingPlayer);

        return convertFromPlayerToDto(dicePlayerRepository.save(existingPlayer));
    }
